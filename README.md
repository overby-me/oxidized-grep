...
> [`safety/oxidized/grep`](https://tangled.org/overby.me/overby.me/tree/main/safety/oxidized/grep) and where all development happens.
>
> It is also published on its own, as
> [tangled.org/overby.me/oxidized-grep](https://tangled.org/overby.me/oxidized-grep) and
> [github.com/overby-me/oxidized-grep](https://github.com/overby-me/oxidized-grep). Both
