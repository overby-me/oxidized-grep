...
> [`safety/oxidized/grep`](https://tangled.org/overby.me/overby.me/tree/main/rust/grep) and where all development happens.
>
> It is also published on its own, as
> [tangled.org/overby.me/rust-grep](https://tangled.org/overby.me/rust-grep) and
> [github.com/overby-me/rust-grep](https://github.com/overby-me/rust-grep). Both
